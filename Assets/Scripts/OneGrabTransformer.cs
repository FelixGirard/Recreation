...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class OneGrabTransformer : MonoBehaviour, ITransformer
    {
        ...
        public void UpdateTransform()
        {
            Pose grabPoint = _grabbable.GrabPoints[0];
            var targetTransform = _grabbable.Transform;
            var newRotation = grabPoint.rotation * _grabDeltaInLocalSpace.rotation;
            targetTransform.rotation = Quaternion.Euler(targetTransform.eulerAngles.x, newRotation.eulerAngles.y, targetTransform.eulerAngles.z);
